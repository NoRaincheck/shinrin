...
lint:
    ...
    uv run ty check --ignore unresolved-import --exclude "src/shinrin/_skgarden/**" --exclude "src/shinrin/_skrules/**" --exclude "src/shinrin/_corels/**" --exclude "src/shinrin/_spot/**" --exclude "tests/vendored/**" src/ tests/
