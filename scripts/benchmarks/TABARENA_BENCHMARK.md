...
|---|---|---|---|---|---|---|
| fish-toxicity | 0.000498 | 0.00961 | 0.129 | 0.0841 | 0.202 | 0.177 |
| concrete-strength | 0.000593 | 0.0117 | 0.163 | 0.109 | 0.25 | 0.22 |
| insurance-expenses | 0.000819 | 0.0141 | 0.141 | 0.111 | 0.317 | 0.294 |
| airfoil-noise | 0.000753 | 0.0156 | 0.144 | 0.118 | 0.359 | 0.337 |
| fiat-500 | 0.00084 | 0.0158 | 0.191 | 0.133 | 0.339 | 0.316 |

*Predict: ms per full test-set call / ms per 1k samples.*

| Dataset | MondrianTree | MondrianForest | RandomForest | ExtraTrees | RF-Quantile | ET-Quantile |
|---|---|---|---|---|---|---|
| fish-toxicity | 0.0705 / 0.388 | 1.41 / 7.77 | 5.14 / 28.2 | 5.38 / 29.5 | 2.52 / 13.8 | 2.58 / 14.2 |
| concrete-strength | 0.0809 / 0.393 | 1.65 / 8.03 | 5.29 / 25.7 | 5.66 / 27.5 | 2.76 / 13.4 | 2.9 / 14.1 |
| insurance-expenses | 0.102 / 0.382 | 2.21 / 8.24 | 6.06 / 22.6 | 6.6 / 24.6 | 3.12 / 11.6 | 3.15 / 11.7 |
| airfoil-noise | 0.111 / 0.369 | 2.51 / 8.35 | 6.48 / 21.5 | 7.02 / 23.3 | 3.31 / 11 | 3.46 / 11.5 |
| fiat-500 | 0.104 / 0.339 | 2.34 / 7.61 | 6.38 / 20.7 | 7.25 / 23.5 | 3.33 / 10.8 | 3.34 / 10.8 |

*R^2 on the held-out test set.*

| Dataset | MondrianTree | MondrianForest | RandomForest | ExtraTrees | RF-Quantile | ET-Quantile |
|---|---|---|---|---|---|---|
| fish-toxicity | 0.1246 | 0.5593 | 0.5936 | 0.5568 | 0.6031 | 0.5902 |
| concrete-strength | 0.6306 | 0.8422 | 0.9037 | 0.9208 | 0.9030 | 0.9090 |
| insurance-expenses | -0.6839 | 0.4749 | 0.8340 | 0.8222 | 0.8346 | 0.8385 |
| airfoil-noise | 0.0323 | 0.3817 | 0.9444 | 0.9605 | 0.9431 | 0.9457 |
| fiat-500 | 0.7514 | 0.8147 | 0.8460 | 0.8388 | 0.8450 | 0.8413 |
...
|---|---|---|---|---|
| blood-transfusion | 0.000424 | 0.00872 | 0.00112 | 0.00115 |
| pima-diabetes | 0.000536 | 0.0103 | 0.00523 | 0.0151 |
| credit-g | 0.000724 | 0.0157 | 0.0408 | 0.0106 |
| qsar-biodeg | 0.00106 | 0.0212 | 0.0414 | 0.0134 |
| seismic-bumps | 0.00118 | 0.0252 | 0.00233 | 0.00214 |
| churn | 0.00293 | 0.0548 | 0.0037 | 0.0457 |
| anneal | 0.000793 | 0.0183 | - | - |
| maternal-health | 0.000607 | 0.0108 | - | - |
| website-phishing | 0.000646 | 0.0132 | - | - |

*Predict: ms per full test-set call / ms per 1k samples.*

| Dataset | MondrianTree | MondrianForest | GOSDT | CORELS |
|---|---|---|---|---|
| blood-transfusion | 0.0822 / 0.548 | 0.875 / 5.83 | 0.0708 / 0.472 | 0.00989 / 0.0659 |
| pima-diabetes | 0.0898 / 0.583 | 0.906 / 5.88 | 0.0897 / 0.582 | 0.011 / 0.0714 |
| credit-g | 0.123 / 0.617 | 1.29 / 6.44 | 0.0911 / 0.455 | 0.0134 / 0.0669 |
| qsar-biodeg | 0.0891 / 0.422 | 0.916 / 4.34 | 0.11 / 0.52 | 0.0224 / 0.106 |
| seismic-bumps | 0.158 / 0.305 | 1.98 / 3.83 | 0.15 / 0.29 | 0.0187 / 0.0362 |
| churn | 0.324 / 0.324 | 3.88 / 3.88 | 0.291 / 0.291 | 0.0401 / 0.0401 |
| anneal | 0.106 / 0.589 | 1.36 / 7.54 | - | - |
| maternal-health | 0.0986 / 0.486 | 1.13 / 5.59 | - | - |
| website-phishing | 0.112 / 0.412 | 1.38 / 5.11 | - | - |

*Accuracy on the held-out test set.*

| Dataset | MondrianTree | MondrianForest | GOSDT | CORELS |
|---|---|---|---|---|
| blood-transfusion | 0.6933 | 0.6800 | 0.7600 | 0.7600 |
| pima-diabetes | 0.7468 | 0.7403 | 0.7727 | 0.7662 |
| credit-g | 0.6400 | 0.6750 | 0.7000 | 0.7000 |
| qsar-biodeg | 0.7820 | 0.8341 | 0.7393 | 0.8246 |
| seismic-bumps | 0.9033 | 0.9207 | 0.9342 | 0.9342 |
| churn | 0.8540 | 0.8800 | 0.8590 | 0.8590 |
| anneal | 0.8278 | 0.8611 | - | - |
| maternal-health | 0.7586 | 0.8177 | - | - |
| website-phishing | 0.8450 | 0.8745 | - | - |
